...
<html>
<head>
<title><?php echo $this->lang->line('website_title'); ?> | <?php echo $this->lang->line('about_title'); ?> </title>
	...
	<div class="header">
		...
		<div class="h_right">
			<ul class="menu">
				...
				<li class="active"><a href="about"><?php echo $this->lang->line('menu_about'); ?></a></li>
...
<div class="wrap">
	<div class="slider">
		<h2><?php echo $this->lang->line('about_title'); ?></h2>
			...
			<div class="about">
			       ...
			       <div class="cont-grid">
			    	...
			    	<div class="about-p">
						...
						<p class="para">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
						<div class="read_more">
							<a class="btn" href="details"><?php echo $this->lang->line('about_readmore'); ?></a>
						</div>
					</div>
			</div>
			<!-- end about -->
