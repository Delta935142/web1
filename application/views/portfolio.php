...
<html>
<head>
<title>The Calm Website Template | Portfolio </title>
	...
	<div class="header">
		...
		<div class="h_right">
			<ul class="menu">
				...
				<li class="active"><a href="portfolio"><?php echo $this->lang->line('page_portfolio'); ?></a></li>
	        ...
	        <nav class="nav">
	            <ul class="nav-list">
	                ...
	                <li class="nav-item"><a href="about"><?php echo $this->lang->line('page_about'); ?></a></li>
	                <li class="nav-item"><a href="portfolio"><?php echo $this->lang->line('page_portfolio'); ?></a></li>
	                <li class="nav-item"><a href="blog"><?php echo $this->lang->line('page_blog'); ?></a></li>
	                <li class="nav-item"><a href="contact"><?php echo $this->lang->line('page_contact'); ?></a></li>
	                <div class="clear"></div>
	            </ul>
	        </nav>
